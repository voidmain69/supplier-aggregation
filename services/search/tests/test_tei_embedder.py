...
import httpx
from search.adapters.embedder import TeiEmbedder, build_embedder
from search.domain.embedding import EMBEDDING_DIM, HashingEmbedder
...
def test_tei_embedder__posts_batch_of_one_and_unwraps_vector() -> None:
    ...
    assert embedder.embed("wireless mouse") == [0.1, 0.2, 0.3, 0.4]
