...
EVENT_REGISTRY: dict[str, EventSpec] = {
    "catalog.product.updated": EventSpec(
        event_type="catalog.product.updated",
        model=CatalogProductUpdated,
        topic="sa.catalog.product",
        dataschema="https://contracts.sa.internal/events/catalog.product.updated.json",
    ),
